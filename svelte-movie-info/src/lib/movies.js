...
// 대표 모듈 (export default) - 해당 모듈(js파잃)에서 대표하는 한가지만 export 하는것
// sayHello는 데이터가 2개인데 지금 여기는 data하나니까 대표모듈로 내보낼 수 있음